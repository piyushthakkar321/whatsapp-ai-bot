...
def save_to_sheet(data):
    ...
    sheet = client.open("WhatsApp Leads").sheet1
    sheet.append_row([
...
def handle_flow(msg, sender, incoming_msg, text, step):
    ...
    if step == 1:
        ...
        if incoming_msg in SERVICES:
            ...
            users[sender]["step"] = 3
            msg.body("Nice choice! 👍 What is your *budget* for this project?")
        else:
            msg.body(
        ...
        users[sender]["step"] = 4
        msg.body("Got it 💰 What is your *deadline* or expected timeline?")
